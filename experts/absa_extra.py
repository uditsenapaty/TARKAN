...
Three public aspect-sentiment corpora, same 3-class label set, same "aspect marked in the
...
The Twitter one matters most: same surface domain, same @-mention/hashtag noise, same
entity-as-aspect convention. It alone is **2× t2015's train set**.
